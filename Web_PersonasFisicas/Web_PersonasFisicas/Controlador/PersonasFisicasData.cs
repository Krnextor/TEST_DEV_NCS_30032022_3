...
namespace Web_PersonasFisicas.Controlador
{
    ...
    {
        public DB_Result Registrar(PersonasFisicas Persona)
        {
        ...
        public DB_Result Actualizar(PersonasFisicas Persona)
        {
        ...
        public DB_Result Eliminar(PersonasFisicas Persona)
        {
        ...
        public PersonasFisicas ConsultarUnaPersona(PersonasFisicas Persona)
        {
        ...
        public List<PersonasFisicas> ConsultarPersonasFisicas()
        {
