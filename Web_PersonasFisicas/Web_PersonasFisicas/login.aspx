<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Web_PersonasFisicas.login" %>
...
<body>
    ...
    <asp:TextBox ID="User" runat="server" PlaceHolder="Distrito" CssClass="txtControl" ></asp:TextBox>
